...
const createOrder = async (req, res) => {
    ...
    try {
        ...
        const { rows } = await client.query(
            `INSERT INTO orders (client_id, user_id, garment_type, deadline, price, deposit, fabric_notes, notes)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
            [client_id, req.userId, garment_type, deadline, price || 0, deposit || 0, fabric_notes, notes]
        );
        const order = rows[0];
        if (measurements) {
